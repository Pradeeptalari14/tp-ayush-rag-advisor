# 🌿 Ayush RAG (Traditional Medicine Advisor)

> Information advisor on traditional Ayuverda remedies and drug interactions. Emits warnings to Slack.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/ayush-rag-advisor/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-ayush-rag-advisor.git
cd tp-ayush-rag-advisor
```
...
```bash
kubectl port-forward deployment/tp-ayush-rag-advisor 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── ayush_advisor.py     # Main configuration file
```
...
---
*Generated by [Ayush RAG (Traditional Medicine Advisor) Studio](https://pradeeptalari14.github.io/portfolio/tools/ayush-rag-advisor/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
